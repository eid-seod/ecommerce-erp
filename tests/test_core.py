...
def test_account_and_invoice_operations(client):
    ...
    invoice=client.post('/api/invoices',json={'partner_id':'','invoice_date':'','description':'Demo service','quantity':'2','unit_price':'100','tax_rate':'15'},headers={'X-CSRF-Token':csrf})
